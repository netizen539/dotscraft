...
namespace Unity.Entities
{
    ...
    internal unsafe class ArchetypeManager : IDisposable
    {
        ...
        {
            m_Entities->RemoveComponent(entity, ComponentType.ReadWrite<ChunkHeader>(), this, m_SharedComponentManager, m_groupManager);
            m_Entities->TryRemoveEntityId(&entity, 1, this, m_SharedComponentManager);
        }
